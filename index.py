...
class IPInfo:
    ...
    def SearchIP(self, IP):
        ...
        #print(json.dumps(result.all, sort_keys=False, indent=2))
...
def mainIPInfo():
    ...
    if len(API) < 1:
        ...
        print("")
        print("Ingresa a {}    {} para ver tu access token")
        print("")
...
def mainExploits():
    ...
    if option == '01' or option == '1':
        ...
        if os.path.exists("geckodriver") == True:
...
def mainPhishing():
    print("")
    print("[{}01{}] SocialFishing".format(color, Fore.LIGHTWHITE_EX))
    ...
    if options == '01' or options == '1':
        if os.path.exists("core/SocialFishing/") == False:
            os.system("cd core/ && git clone https://github.com/GitMx2022/SocialFishing.git")
            print("Ok")

        print("")
        try:
            os.system("cd core/SocialFishing/ && sudo python3 SocialFish.py admin admin && echo Ok")
...
def Configurate():
    ...
    option = input(str(" Hacking-Tools ({}Configuracion{}) > "))
